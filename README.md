...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=E2ELanguageSelectApi&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=E2ELanguageSelectApi&workspaceName=e-2-e-language-select-apilib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *E2E Language Select APILib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add E2ELanguageSelectApilib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=E2ELanguageSelectApi&workspaceName=e-2-e-language-select-apilib&step=importDependency)
...
![Install E2ELanguageSelectApilib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
...
import {
  ...
  LogLevel,
  OAuthScope,
} from 'e-2-e-language-select-apilib';
...
const client = new Client({
  authorizationCodeAuthCredentials: {
    ...
    oAuthScopes: [
      OAuthScope.CrmObjectsContactsRead
    ]
  },
  timeout: 0,
...
import { Client } from 'e-2-e-language-select-apilib';
